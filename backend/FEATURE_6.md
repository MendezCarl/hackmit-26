...
[API handoff](../docs/api/lecture_features.md#provider-boundaries-and-honest-status) describes this feature
...
This branch implements folder/material/export operations. Shared phone
documentation describes another feature and does not add signal or professor
routes here. Live OAuth and account verification remain host work.
