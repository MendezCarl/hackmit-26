# professor-metrics: feature review
...
- `backend/app/professor/metrics.py`
- `backend/app/professor/metrics_routes.py`
...
The focused checks are under `backend/tests/feature_professor_metrics/`.
