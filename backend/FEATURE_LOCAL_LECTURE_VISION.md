# local-lecture-vision: feature review
...
- `backend/app/local_ml/__init__.py`
- `backend/app/local_ml/vision.py`
- `backend/app/local_ml/worker.py`
...
The focused checks are under `backend/tests/feature_local_lecture_vision/`.
