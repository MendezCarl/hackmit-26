# openai-recovery: feature review
...
- `backend/app/integrations/openai/recovery.py`
- `backend/scripts/check_openai_synthetic.py`
...
The focused checks are under `backend/tests/feature_openai_recovery/`.
